        ...
        <Route path={`${path}/user`}>
          ...
          >
            <div className="loginnn">
              ...
              <picture>
                <source id="backgroung-login" media="(min-width: 950px)" srcset="https://nmc.gov.in/assets/admin/upload/silder/Nashik_Panchavati.jpg" style={{"position":"absolute","height":"100%","width":"100%"}} />
                  <source media="(min-width: 250px)" srcset="https://nugp-assets.s3.ap-south-1.amazonaws.com/nugp+asset/Banner+UPYOG+%28500x900%29.jpg" />
                    <img src="https://nmc.gov.in/assets/admin/upload/silder/Nashik_Panchavati.jpg" alt="imagealttext" style={{"position":"absolute","height":"100%","width":"100%","zIndex":"1","display":window.location.href.includes("user/profile")?"none":""}}/>
                    </picture>
